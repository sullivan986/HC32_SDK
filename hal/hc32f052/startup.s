...
@  Target toolchain: ATfE (Arm Toolchain for Embedded, clang + picolibc)
@
@  Written in GNU assembler syntax, assembled by the ATfE clang
@  integrated assembler (LLVM). Link with -nostartfiles against the
@  matching linker script Link.ld (same directory), e.g.:
@
